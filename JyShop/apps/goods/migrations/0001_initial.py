# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-02-28 06:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default='', help_text='类code', max_length=30, verbose_name='类code')),
                ('desc', models.TextField(default='', help_text='类别描述', verbose_name='类别描述')),
                ('category_type', models.IntegerField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类目')], help_text='类别描述', verbose_name='类目级别')),
