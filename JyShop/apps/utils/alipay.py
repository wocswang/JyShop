...
if __name__ == "__main__":
    ...
    alipay = AliPay(
        appid="2016091100490155",
        app_notify_url="http://127.0.0.1:8000/alipay/return/",
        app_private_key_path="C:/Users/Administrator/PycharmProjects/JyShop/apps/trade/keys/private_2048.txt",
        alipay_public_key_path="C:/Users/Administrator/PycharmProjects/JyShop/apps/trade/keys/alipay_key_2048.txt",  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
        debug=True,  # 默认False,
